...
const tags = [
  { text: 'LangChain',   top: '12%', left: '58%', size: '0.82rem', opacity: 0.55, color: '#9b5de5', anim: 'floatA', dur: '13s', delay: '0s'   },
  ...
  { text: 'FAISS',       top: '22%', left: '85%', size: '0.78rem', opacity: 0.5,  color: '#9b5de5', anim: 'floatA', dur: '11s', delay: '-7s'  },
  ...
  { text: 'pgvector',    top: '78%', left: '65%', size: '0.73rem', opacity: 0.38, color: '#9b5de5', anim: 'floatD', dur: '17s', delay: '-2s'  },
  ...
  { text: 'Microservices', top: '17%', left: '68%', size: '0.7rem', opacity: 0.35, color: '#9b5de5', anim: 'floatB', dur: '20s', delay: '-6s' },
